...
def post_chunks_to_api(file, chunks, collection, doc_type):
    url = 'https://hanna-enterprise-live-api-a989d07ab584.herokuapp.com/add-master-object/file/' #chay
    data = {
        'chunks': chunks,
...
def chat_with_model(query):
    api_url = "https://hanna-enterprise-live-api-a989d07ab584.herokuapp.com/chat/" #chay      
    payload = {
        "collection": "001",
        "query": query,
        "entity": "CMV",
...
def view_logs():
    ...
    if logs:
        ...
        def kl(collection, message):
            ...
            url = 'https://hanna-enterprise-live-api-a989d07ab584.herokuapp.com/remove-master-objects/uuid/' #chay
            data = {
                'collection': collection,
                'uuid': result
            }
